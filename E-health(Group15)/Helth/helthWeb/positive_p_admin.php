            ...
            <div class="container-fluid">
                <div class="row min-vh-100 flex-column flex-md-row">
                    ...
                    <main class="col-sm-10 bg-faded py-3 flex-grow-1">
                        <h2 class="page_head">Positive Patients</h2>
                        <table id="citizen_view" class="table table-bordered table-hover dt-responsive"  >
                            ...
                            $url= $apiUrl."citizen/positivecitizen";
                            $ch = curl_init();
                            ...
                            if($responseData != null){
                                foreach ($responseData  as $key => $value) {
                                    echo "<tr> <td>".  $value["fname"]. "</td><td> ". $value["lname"]. "</td><td> ". $value["nic"]. "</td><td> "
                                        . $value["address"].  "</td><td> ". $value["email"]. "</td><td> "
                                        . $value["location"]. "</td><td> ". $value["results"]. "</td><td> "

                                    ?>
                                    <form action="controller/sendEmail.php" method="post">
                                        <input type="hidden" name="email" id="email"  value="<?php echo $value["email"];?>" >

                                        <button type="submit" name="submit" class="btn btn-danger">Email</button>
                                        </td></tr>
                                    </form>
                                    <?php
    ...
    <script>
        ...
        function automagick(type, selItem, data, classes){
            ...
            if (type=='select') {
                ...
                out = "<button>Email</button>" ;
                if (typeof classes !== 'undefined') {
                    out = '<button class="' + classes + '">Email</button>' ;
                }
            } else if(type=='button') {
