...
class AllCitizenViewAdmin extends StatefulWidget {
  @override
  _AllCitizenViewAdminState createState() => _AllCitizenViewAdminState();
}
var searchId;
class _AllCitizenViewAdminState extends State<AllCitizenViewAdmin> {
  void initState() {
    super.initState();
    user ();
    super.initState();
  ...
  Future<List> getData() async {
    print(searchId);
    final response = await http.get("$ip/citizen/citizens/");
    SharedPreferences prefs = await SharedPreferences.getInstance();
