...
class CitiHealthListPage extends StatefulWidget {
  @override
  _CitiHealthListPageState createState() => _CitiHealthListPageState();
}
String cid;
class _CitiHealthListPageState extends State<CitiHealthListPage> {
  void initState() {
    super.initState();
    user ();
    super.initState();
