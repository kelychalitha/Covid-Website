...
class PhiViewAdminAll extends StatefulWidget {
  @override
  _PhiViewAdminAllState createState() => _PhiViewAdminAllState();
}
var searchId;
class _PhiViewAdminAllState extends State<PhiViewAdminAll> {
  void initState() {
    super.initState();
    user ();
    super.initState();
  ...
  Future<List> getData() async {
    print(searchId);
    final response = await http.get("$ip/phi/phis");
