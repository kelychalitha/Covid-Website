...
class PhiViewAdmin extends StatefulWidget {
  @override
  _PhiViewAdminState createState() => _PhiViewAdminState();
}
var searchId;
class _PhiViewAdminState extends State<PhiViewAdmin> {
  void initState() {
    super.initState();
    user ();
    super.initState();
  ...
  Future<List> getData() async {
    print(searchId);
    final response = await http.get("$ip/phi/phi/$searchId");
