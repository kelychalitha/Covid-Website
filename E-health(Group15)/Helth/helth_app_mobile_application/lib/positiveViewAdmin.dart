...
import 'package:health_care/positiveadmin.dart';
...
import 'searchPositive.dart';

class PositiveViewAdmin extends StatefulWidget {
  @override
  _PositiveViewAdminState createState() => _PositiveViewAdminState();
}
var searchId;
class _PositiveViewAdminState extends State<PositiveViewAdmin> {
  void initState() {
    super.initState();
    user ();
    super.initState();
  ...
  user () async {
    ...
    searchId= prefs.getString("search-key4");
  ...
  Future<List> getData() async {
    print(searchId);
    final response = await http.get("$ip/citizen/positivecitizen");
