            ...
            <div class="container-fluid">
                <div class="row min-vh-100 flex-column flex-md-row">
                    ...
                    <main class="col-sm-10 bg-faded py-3 flex-grow-1">
                        <h2 class="page_head">Health Status</h2>
...
echo "<tr> <td>".  $value["nic"]. "</td><td> ". $value["fname"]. "</td><td> ". $value["lname"]. "</td><td> ". $value["age"]. "</td><td> "
    . $value["address"]. "</td><td> ". $value["profeson"]. "</td><td> ". $value["email"]. "</td><td> ". $value["affilication"]. "</td><td> "
    . $value["location"]. "</td><td> ". $value["date"]. "</td><td> "

    ?>
<form action="controller/updateHelth.php" method="post">
    <input type="hidden" name="id" id="citId"  value="<?php echo $value["_id"];?>" >
    <input type="hidden" name="nic" id="nic"  value="<?php echo $value["nic"];?>" >
