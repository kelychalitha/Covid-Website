...
<div class="container-fluid bg">
    <div class=row>
        ...
        <div class="col-md-4 col-sm-4 col-x-12">
            <!-- form start -->
            <form class="form-container" method="post" action="controller/adminLogin.php">
                <h1>Login </h1>
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="pass" id="exampleInputPassword1" placeholder="Enter Passward">
                </div>
                <!-- <div class="checkbox">
